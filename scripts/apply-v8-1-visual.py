...
HOTFIX = Path("public/app-v8_3_1.js")
...
tag = '<script src="/app-v8_3_1.js?v=8.3.1" defer></script>'

if tag not in html:
    anchor = '<script src="/app-v8_3.js?v=8.3.0" defer></script>'
    if anchor not in html:
        raise SystemExit("v8.3 app tag was not found.")
...
print("AEGIS v8.3.1 polish hotfix prepared.")
