...
try:
    from .aegis_ncaaf_engine import ENGINE_VERSION, SPORT_KEY
except ImportError:
    from aegis_ncaaf_engine import ENGINE_VERSION, SPORT_KEY
...
def archive_document(blind: Mapping[str, object], original_json: str | None = None) -> dict:
    ...
    if "market" in blind or "market_expressions" in blind: raise ValueError("Archived NCAAF blind cannot contain market data")
